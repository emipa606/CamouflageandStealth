...
namespace CompCamo
{
	...
	public class CamoPresetColour
	{
		...
		public static Color Orange
		{
			get
			{
				return new Color(0.870588243f, 0.509803951f, 0f, 1f);
			}
		}
		...
		public static Color Purple
		{
			get
			{
				return new Color(0.5019608f, 0f, 0.3372549f, 1f);
			}
		}
		...
		public static Color Violet
		{
			get
			{
				return new Color(1f, 0.41568628f, 0.7607843f, 1f);
			}
		}
		...
		public static Color Brown
		{
			get
			{
				return new Color(0.392156869f, 0.1254902f, 0.0784313753f, 1f);
			}
		}
		...
		public static List<Color> colourChoices()
		{
			return new List<Color>
			{
				...
				Color.yellow,
				Color.cyan,
				CamoPresetColour.Purple,
				CamoPresetColour.Orange,
				CamoPresetColour.Brown,
				CamoPresetColour.Violet
			};
		}
		...
		public static string GetClosestType(Apparel apparel)
		{
			...
			List<Color> list = CamoPresetColour.colourChoices();
			if (list.Count > 0)
			{
				float num = 9f;
				foreach (Color color2 in list)
				{
					float num2 = CamoPresetColour.ColourCompare(drawColor, color2);
					if (num2 < num)
					{
						color = color2;
						num = num2;
			...
			else if (color == CamoPresetColour.Orange)
			{
				result = "Orange";
			}
			...
			else if (color == CamoPresetColour.Violet)
			{
				result = "Violet";
			}
			else if (color == CamoPresetColour.Purple)
			{
				result = "Purple";
			}
			else if (color == CamoPresetColour.Brown)
			{
				result = "Brown";
			}
			return result;
